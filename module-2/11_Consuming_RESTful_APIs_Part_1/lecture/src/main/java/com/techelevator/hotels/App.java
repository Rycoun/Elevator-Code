    ...
    private void run() {
        ...
        while (menuSelection != 0) {
            ...
            if (menuSelection == 1) {
                ...
                Hotel[] hotelsRated = hotelService.getHotelsByStarRating(3);
                consoleService.printHotels(hotelsRated);

            } else if (menuSelection == 6) {

                City city = hotelService.getWithCustomQuery();
                System.out.println(city.getFullName() + " " + city + city.getGeonameId());
