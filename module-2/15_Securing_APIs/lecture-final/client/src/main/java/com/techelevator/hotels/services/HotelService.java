...
public class HotelService {
    ...
    public Reservation addReservation(Reservation newReservation) {
        ...
        headers.setBearerAuth(authToken); // Authorization: Bearer <authToken>
        ...
        try {
            ResponseEntity<Reservation> responseEntity = restTemplate.exchange(url, HttpMethod.POST, entity, Reservation.class);
    ...
    public boolean deleteReservation(int id) {
        boolean success = false;
        try {
            restTemplate.exchange(API_BASE_URL + "reservations/" + id, HttpMethod.DELETE, makeAuthEntity(), Void.class);
            success = true;
        } catch (RestClientResponseException | ResourceAccessException e) {
            BasicLogger.log(e.getMessage());
        }
