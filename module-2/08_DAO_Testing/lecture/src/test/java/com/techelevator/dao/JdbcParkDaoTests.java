...
public class JdbcParkDaoTests extends BaseDaoTests {
    ...
    public void getParksByState_with_invalid_state_returns_empty_list() {
        ...
        Assert.assertEquals(0, parksInXX);
    }
    ...
    public void createPark_creates_park() {
        ...
        Park givenPark = sut.getParkById(newParkID);
        assertParksMatch(createdPark,givenPark);
    ...
    public void updatePark_updates_park() {
        ...
        Park givenPark = sut.getParkById(park2.getParkId());
        assertParksMatch(updatedPark, givenPark);
