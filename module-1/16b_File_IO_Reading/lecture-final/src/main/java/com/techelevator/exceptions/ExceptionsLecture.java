...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		while (true) {
			try {
				...
				break;
			} catch (NumberFormatException e) { // If a NumberFormatException is thrown by Integer.valueOf(...) it will be caught here since NumberFormatException "is-a" Exception
				System.out.println("You did it wrong... Please enter a valid integer.");
			}
			System.out.println();
		}
	...
	private static double calculateHotelRoomCharges(int nights, int numberOfGuests) {
		...
		if (nights < 1) {
			IllegalArgumentException someObject = new IllegalArgumentException("asdfsadfasd");
