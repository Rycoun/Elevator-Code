...
public class BankAccountData {
    ...
    private File bankAccountsFile = new File("bankaccounts.txt");
    public BankAccountData() {

        File accountFile = new File("bankaccounts.txt");
    ...
    public void saveAccounts() {
        try(PrintWriter printWriter = new PrintWriter(bankAccountsFile)) {
