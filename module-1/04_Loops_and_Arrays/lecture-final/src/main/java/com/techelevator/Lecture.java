...
public class Lecture {
    ...
    */
    public int returnFirstElement() {
        int[] portNumbers = { 80, 8080, 443 }; // [80, 8080, 443]
    ...
    */
    ...
    /*
        doesContainOne
        howManyOnes
        areThereExactlyTwoOnes
        howManyNumbersDivisibleByIndex
        printNamesInReverse
    ...
    /*
        ...
        [ 2, 5, 1, 1 ] -> true
     */
    public boolean doesContainOne(int[] nums) {
    ...
    public boolean areThereExactlyTwoOnes(int[] nums) {
        int counter = howManyOnes(nums);
     ...
     */
    public int howManyElementsDivisibleByIndex(int[] nums) {
        int counter = 0;
     ...
     */
    public int[] doubleEachElement(int[] nums) {
    ...
    public int[] doStuffWithArray() {
        int[] a = { 1, 5, 10 };

        doOtherStuffWithArray(a);

        return a;
    }

    public void doOtherStuffWithArray(int[] otherNums) {
        int[] copy = new int[otherNums.length];

        for (int i = 0; i < otherNums.length; i++) {
            copy[i] = otherNums[i];
        }

        otherNums[0] = otherNums[0] * 2;
    }
