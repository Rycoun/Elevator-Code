...
public class ExercisesTest {
	...
	public void less20() {
		...
		assertEquals(true, exercises.less20(38));
		assertEquals(true, exercises.less20(39));
		assertEquals(false, exercises.less20(40));
		assertEquals(false, exercises.less20(21));
		assertEquals(false, exercises.less20(41));
	}
	...
	public void answerCell() {
		...
		assertEquals(true, exercises.answerCell(false, true, false));
		assertEquals(false, exercises.answerCell(false, true, true));
		assertEquals(false, exercises.answerCell(true, false, true));
		assertEquals(true, exercises.answerCell(true, true, false));
		assertEquals(false, exercises.answerCell(true, true, true));
	}
	...
	public void teaParty() {
		...
		assertEquals("Input: teaParty(6, 8)", 1, exercises.teaParty(5, 5));
