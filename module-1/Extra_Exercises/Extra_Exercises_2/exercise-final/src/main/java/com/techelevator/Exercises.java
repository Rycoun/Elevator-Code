...
public class Exercises {
     ...
     */
      ...
      {
          boolean isIcyHot = (temp1 < 0 && temp2 > 100) || (temp2 < 0 && temp1 > 100);
          return isIcyHot;
      }
      ...
      {
          boolean hasSingleTeen = (a >= 13 && a <= 19) || (b >= 13 && b <= 19) || (c >= 13 && c <= 19);
          return hasSingleTeen;
      }
      ...
      {
          boolean loneTeen = (a >= 13 && a <= 19) ^ (b >= 13 && b <= 19);
          return loneTeen;
      }
      ...
      public int max1020(int a, int b)
      {
          ...
          if (b > a)
          {
        	  // Usually, swapping is implemented using a third variable like "swap".
              int swap = a;
              a = b;
              b = swap;
